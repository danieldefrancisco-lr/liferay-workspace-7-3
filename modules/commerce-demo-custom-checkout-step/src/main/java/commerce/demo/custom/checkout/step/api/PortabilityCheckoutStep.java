...
@Component(immediate = true, property = {
	"commerce.checkout.step.name=" + PortabilityCheckoutStep.NAME,
	"commerce.checkout.step.order:Integer=1"
}, service = CommerceCheckoutStep.class)
public class PortabilityCheckoutStep implements CommerceCheckoutStep {

	public static final String NAME = "Portability Service Booking";
	...
	@Reference(target = "(osgi.web.symbolicname=commerce.demo.custom.checkout.step)")
